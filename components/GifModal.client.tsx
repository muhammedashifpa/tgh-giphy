...
export const GifModal = ({ gif, isLoading, onClose }: GifModalProps) => {
  ...
  return createPortal(
    ...
    >
      ...
      <div 
        className="relative max-w-7xl w-full h-[90vh] flex flex-col bg-zinc-950 rounded-2xl overflow-hidden shadow-2xl border border-zinc-800/50 animate-in zoom-in-95 duration-300"
